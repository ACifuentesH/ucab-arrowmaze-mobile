...
/// cuando está disponible, del católogo (flechas / dificultad / límite).
abstract final class ProgressMapper {
  /// Convierte GET/PUT `/progress` ΓåÆ entradas locales.
  ///
  ...
  /// Estrellas 1ΓÇô3 a partir del score remoto y el preview del nivel (si existe).
  static int starsFromScore(int score, LevelPreview? preview) {
    if (score <= 0) return 1;
    if (preview == null) {
      // Sin cat├ílogo: umbrales absolutos razonables post-hidrataci├│n.
